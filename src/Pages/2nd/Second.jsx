  ...
  return (
    ...
    <div className="fixed top-0 left-0 p-4">
      ...
      <div className="md:container md:mx-auto pt-60 grid grid-cols-2 md:grid-cols-5 gaps-4">
          ...
          <div className='place-self-center col-span-2 mt-20'>
          ...
          <div className='place-self-center col-span-3 mt-20'>
          ...
          <div className='place-self-center col-start-2 mt-20'>
          ...
          <div className='place-self-center md:mt-20'>
